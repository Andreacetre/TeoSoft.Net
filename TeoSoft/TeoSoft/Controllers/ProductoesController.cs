...
namespace TeoSoft.Controllers
{
    public class ProductoesController : Controller
    {
        ...
        {
            ViewData["CategoriaProductoId"] = new SelectList(_context.CategoriasProductos, "IdCatProduc", "IdCatProduc");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ProductoId,CodigoDeBarra,Nombre,Precio,Stock,Descripcion,IVA,FechaVencimiento,SinVencimiento,Estado,CategoriaProductoId")] Producto producto)
        {
            ...
            ViewData["CategoriaProductoId"] = new SelectList(_context.CategoriasProductos, "IdCatProduc", "IdCatProduc", producto.CategoriaProductoId);
            return View(producto);
        }
