...
namespace TeoSoft.Controllers
{
    public class PedidoesController : Controller
    {
        ...
        {
            ViewData["IdCliente"] = new SelectList(_context.Clientes, "ClienteId", "ClienteId");
        ...
        public async Task<IActionResult> Create([Bind("IdPedido,IdCliente,IdProducto,DireccionEnvio,MetodoPago,MontoTotal,FechaDelPedido,EstadoPedido")] Pedido pedido)
        {
            ...
            ViewData["IdCliente"] = new SelectList(_context.Clientes, "ClienteId", "ClienteId", pedido.IdCliente);
            ViewData["IdProducto"] = new SelectList(_context.Productos, "ProductoId", "ProductoId", pedido.IdProducto);
            return View(pedido);
        }
